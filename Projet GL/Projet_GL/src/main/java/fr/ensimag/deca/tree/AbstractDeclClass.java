...
public abstract class AbstractDeclClass extends Tree {
    ...
    protected abstract void methodTableCodeGen(DecacCompiler compiler);

    // Field initialization code generation.
    protected abstract void fieldInitCodeGen(DecacCompiler compiler);

    protected abstract void methodCodeGen(DecacCompiler compiler);
}

...
public abstract class Type {
    ...
    public boolean isCompatible(DecacCompiler compiler, Type rType){
        return (isFloat() && rType.isInt()) || sameType(rType);
    }

    public boolean castCompatible(DecacCompiler compiler, Type rType){
        return (!isVoid()) && isCompatible(compiler, rType)
                    && rType.isCompatible(compiler, this);
    }

    public boolean instanceof_op(DecacCompiler compiler, Type rType){
        return this.isClassOrNull() && rType.isClass();
    }
